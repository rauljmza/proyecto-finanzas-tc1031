...
AIO es un sistema de finanzas personales que permite registrar gastos e ingresos, manejar multiples tarjetas de credito y debito, categorizar transacciones, y generar resumenes financieros. Utiliza listas doblemente ligadas para almacenamiento dinamico, stack para deshacer operaciones, y multiples algotimtos de ordenamiento y busqeuda. El proyecto evoluciono de arreglos estaticos con limite de 100 transacciones a estructuras dinamicas sin limite, agregando funcionalidades como importacion/exportacion CSV y manejo completo de tarjetas de credito.
